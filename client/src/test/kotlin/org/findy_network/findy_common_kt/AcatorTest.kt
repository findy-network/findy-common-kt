...
internal class MockExecutor : Executor {
    val testToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1biI6IlJNQWlRZWJ5Z2FNc256U2NSM0R5ZjYiLCJsYWJlbCI6InVzZXItMTY1Mjk1MDk3MDgyNiIsImV4cCI6MTY1MzIxMDE3Mn0.QO5lwjXNELVuTMomBjpfeTVB_HWGiQlxmGWUtsvUD5Y"
    override fun run(command: String): String? {
        if (command.contains("--version"))
            return "findy-agent-cli version 0.24.28"
...
internal class AcatorTest {
    ...
    private val testAcator: Acator = Acator(authUrl = testAuthUrl, authOrigin = testAuthOrigin, userName = testUserName, seed = testSeed, key = testKey, exec = mockExec)
